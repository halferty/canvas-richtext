...
![Tests](https://img.shields.io/badge/tests-488%20passing-brightgreen) ![Coverage](https://img.shields.io/badge/coverage-100%25-brightgreen) ![License](https://img.shields.io/badge/license-MIT-blue)
...
- 🖼 **Images** - Bring-your-own uploader: a thumbnail block you can select, resize (corner + edge handles), justify, and drag to reposition; the full-size URL is captured in the JSON
...
This library features **100% synthetic testing** - all 488 tests run in Node.js without requiring a browser!
